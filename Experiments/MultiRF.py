...
def MultiRF():
    ...
    params['max_depth'] = [10, 50, 100, 500]
    params['class_weight'] = ['balanced']

    grid = GridSearchCV(estimator=RandomForestClassifier(), param_grid=params, cv=cv_folds, n_jobs=2, scoring='f1_weighted')
    grid.fit(X_train_validate, Y_train)
    best_dt_model = RandomForestClassifier(criterion=grid.best_params_['criterion'],
